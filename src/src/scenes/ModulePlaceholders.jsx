...
export function ReportsScene() {
  ...
  return (
    <div>
      <PageHeader
        title="Reports"
        description="Program reporting across requests and subtasks."
        actions={<PageAction>Create report</PageAction>}
      />
      <PageBody>
...
export function SettingsScene() {
  ...
  return (
    <div>
      ...
      <PageBody>
        <div style={{ ...card, padding: 'var(--space-2) var(--space-6)', maxWidth: 760 }}>
