...
export const WORKFLOWS = [
  {
    ...
    systems: ['Marketo'],
    subtasks: ['Suppress marketing preferences in Marketo'],
    steps: 1,
  ...
  },
  {
    ...
    subtasks: [
      'Retrieve data from internal warehouse',
  ...
  },
  {
    ...
    subtasks: [
      ...
      'Delete data from Marketo',
      'Delete data from Zendesk',
      'Delete data from internal warehouse',
      'Route legal-hold edge cases to Legal',
    ],
    steps: 5,
  ...
  },
  {
    ...
    subtasks: [
      'Validate and update record in Salesforce',
      'Validate and update record in Marketo',
      'Validate and update record in Zendesk',
      'Confirm corrected data with requester',
    ],
    steps: 4,
